...
public class UsuarioControllerTest {
	...
	public void atualizarUsuario() {
		...
		Optional<Usuario> usuarioCriar = usuarioService.cadastrarUsuario(new Usuario(0L,"Juliana Andrews", "juliana_andrews@email.com.br", "juliana123"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCriar.get().getId(), 
